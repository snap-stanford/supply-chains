...
#add a RUN ID to this later to distinguish runs
...
parser.add_argument('--product_link', default="buy",
                    help="type of product link, out of {'buy','supply'}")
...
supplychains_run_id = args.run_id
...
results_dict = {"best val score": max_val_score, 
           "best test score": max_test_score, "best validation epoch": best_test_idx + 1,
          "test_curve": test_curve, "val_curve": val_curve, "train_curve": train_curve}

dir = "/lfs/turing1/0/bbyan/supply-chains/TGB/tgb/datasets/archive/nodeprop/"
with open(os.path.join(dir, f"results-{supplychains_run_id}-{product_link}.json"), "w") as file:
